            ...
            <ul class="list-group">
                <?php foreach ($data["mhs"] as $mhs) : ?>
                    <li class="list-group-item">
                        ...
                        <a href="<?= BASEURL; ?>/mahasiswa/ubah/<?= $mhs["id"]; ?>" class="badge btn text-bg-success float-end ms-2 p-2 tampilModalUbah" data-bs-toggle="modal" data-bs-target="#formModal" data-id="<?= $mhs["id"]; ?>">ubah</a>
                ...
                <form action="<?= BASEURL; ?>/mahasiswa/tambah" method="post">
                    ...
                    <div class="form-grup mb-3">
                        ...
                        <select class="form-select mt-2" aria-label="Default select example" id="jurusan" name="jurusan">
                            ...
                            <option value="Teknik Informatika">Desain Komunikasi Visual</option>
